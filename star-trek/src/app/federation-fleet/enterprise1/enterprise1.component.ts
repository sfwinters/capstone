...
export class Enterprise1Component implements OnInit {
  ...
  tosCrew = [
    ...
    },
    {
      ...
      bio: 'Christine Chapel was raised in New Orleans, Louisiana. She demonstrated an early interest in science, originally studying bio-research before eventually enrolling in Starfleet Academy. Her first assignment upon graduation was Head Nurse aboard the USS Enterprise, working under Dr. McCoy. Despite McCoy\'s seemingly brusque personality, they worked well together. Chapel shared McCoy\'s passion for medicine, prioritizing it above her station as an officer, had no reservations about speaking out against his decisions when she felt the situation warranted it, and would eventually go on to become a doctor. She and Uhura were close friends during their time on the Enterprise.',
      id: 'chapel'
    }
  ]
